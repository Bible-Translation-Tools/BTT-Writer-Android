 ...
 */
class UpdateLibraryDialogOld : DialogFragment(), OnEventTalker {
    ...
    override fun onCreateView(
        ...
        with(binding) {
            ...
            updateLanguages.setOnClickListener {
                eventBuffer.write(
                    this@UpdateLibraryDialogOld, EVENT_UPDATE_LANGUAGES, null
                )
            }
            downloadSources.setOnClickListener {
                eventBuffer.write(
                    this@UpdateLibraryDialogOld, EVENT_SELECT_DOWNLOAD_SOURCES, null
                )
            }
            updateSource.setOnClickListener {
                eventBuffer.write(
                    this@UpdateLibraryDialogOld, EVENT_UPDATE_SOURCE, null
                )
            }
            importIndex.setOnClickListener {
                eventBuffer.write(
                    this@UpdateLibraryDialogOld, EVENT_IMPORT_INDEX, null
                )
            }
            downloadIndex.setOnClickListener {
                eventBuffer.write(
                    this@UpdateLibraryDialogOld, EVENT_DOWNLOAD_INDEX, null
                )
            }
            updateAppText.paintFlags = updateAppText.paintFlags or Paint.UNDERLINE_TEXT_FLAG
            updateApp.setOnClickListener {
                eventBuffer.write(
                    this@UpdateLibraryDialogOld, EVENT_UPDATE_APP, null
                )
            }
